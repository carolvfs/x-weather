...
export default class MapWrapper extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        this.state.chart.update(nextProps.event, 
            nextProps.selectedPoints, nextProps.mapIndex, 
            nextProps.globalData, nextProps.globalDomain, 
            nextProps.lensData, nextProps.lensDomain)
    }
